...
*
* SYNTAX: node osx_disk_usage_monitor.js <METRIC_STATE>
* 
* EXAMPLE: node osx_disk_usage_monitor.js "1,1,1,1,1,1"
*
* README:
...
metrics['iused'] =   { retrieveMetric: 1, id: '0000:Used Inodes:4',     get: function(t) { return parseInt(t[5], 10); } };
metrics['ifree'] =   { retrieveMetric: 1, id: '0000:Free Inodes:4',     get: function(t) { return parseInt(t[6], 10); } };
metrics['i%used'] =  { retrieveMetric: 1, id: '0000:% Used Inodes:6',   get: function(t) { return ((parseInt(t[5], 10)/(parseInt(t[5], 10) + parseInt(t[6], 10)))*100).toFixed(2); } };
